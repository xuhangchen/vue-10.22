        ...
        <el-container style="height: 100%;">
            ...
            <el-container style="height: 100%; ">
                <el-header style="height: 60px;">
                    <div style="text-align: center;line-height:60px;height: 60px;">Hello Vue3</div>
                </el-header>
...
<script lang="ts">
import { MenuItem, MenuType, SubMenuItem } from '@/model/menu.model';
...
export default defineComponent({
    ...
    setup() {
        ...
        basicGroup2.subMenuList.push(new MenuItem('卡片', 'card', '/basic/card', MenuType.ITEM));
